...
export const Route = createFileRoute("/_app/@{$workspaceSlug}/~/ledger/")({
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/@{$workspaceSlug}/~/ledger/batch"
            params={{ workspaceSlug }}
            className="inline-flex items-center gap-2 rounded-md bg-secondary px-4 py-2 font-medium text-secondary-foreground text-sm transition-colors hover:bg-secondary/80"
          >
            Batch Entry
          </Link>

          <Link
            to="/@{$workspaceSlug}/~/ledger/new"
            params={{ workspaceSlug }}
