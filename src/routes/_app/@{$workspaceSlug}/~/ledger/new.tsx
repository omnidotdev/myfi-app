...
export const Route = createFileRoute("/_app/@{$workspaceSlug}/~/ledger/new")({
...
function NewJournalEntryPage() {
  ...
  const handleSubmit = useCallback(
    ...
    [activeBookId, navigate, workspaceSlug],
  );

  const handleCancel = () => {
    navigate({ to: "/@{$workspaceSlug}/~/ledger", params: { workspaceSlug } });
  };
